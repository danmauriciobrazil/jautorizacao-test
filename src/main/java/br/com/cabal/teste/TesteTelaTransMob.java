...
public class TesteTelaTransMob {
	...
	public static void main(final String[] args) throws Exception {
		try {
			...
			List<TelaBoxDTO> listaTela  =  srv.obterTransacaoParaTela(398212l, "03/08/2015 05:06:49", 7563009317773l, 1, "CREDITO");

			//final  List<TelaBoxDTO> listaTela  =  srv.obterTransacaoParaTela("6043310000001015", 882257, "01/12/2015 02:41:44", "CREDITO", false);
//			
//			final  List<TelaBoxDTO> listaTela  =  srv.obterTransacaoParaTela("4660700000015139",827422, "11/02/2016 17:21:08", "CREDITO");
//
