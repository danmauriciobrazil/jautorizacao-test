...
public class TesteTelaTrans {
	...
	public static void main(final String[] args) throws Exception {
		try {
			...
			// srv.obterTransacaoParaTela("5127070014662555", 827147,
			// "06/01/2016 14:44:43", "CREDITO", false);

			// final List<TelaBoxDTO> listaTela = srv.obterTran
			// sacaoParaTela("6043310000001015", 882257, "01/12/2015 02:41:44",
			// "CREDITO", false);

			final List<TelaBoxDTO> listaTela = srv.obterTransacaoParaTela("6042034500417897", 32679, "14/06/2016 11:52:31", "DEBITO", false);
